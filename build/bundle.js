...
exports.default = function (req, store) {
  ...
  return renderWithBundle(content);
};

var renderWithoutBundle = function renderWithoutBundle(content) {
  return "\n  <html>\n    <head></head>\n    <body>\n      <div id=\"root\">" + content + "</div>\n    </body>\n  </html>\n";
};
var renderWithBundle = function renderWithBundle(content) {
...
var UserList = function (_React$Component) {
  ...
  function UserList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UserList.__proto__ || Object.getPrototypeOf(UserList)).call.apply(_ref, [this].concat(args))), _this), _this.renderUsers = function () {
